...
class Bottleneck(nn.Module):
    ...
    # This variant is also known as CustomResNet V1.5 and improves accuracy according to
...
def resnet18(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> CustomResNet:
    ...
    """
    return _resnet("resnet18", CustomBlock, [2, 2, 2, 2], progress, **kwargs)